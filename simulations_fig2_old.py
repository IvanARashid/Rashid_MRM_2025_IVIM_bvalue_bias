...
for resolution in resolution_lst:
    ...
    # Run simulation
    bvalues_many, angles = simulate_pulse_sequences.simulate_n_generic_sequences_with_random_encoding_directions(sequence_config=sequence_config, nominal_bvalues=nominal_bvalues, n=n, return_angles=True, plot=False, save_path=save_path, include_imaging=include_imaging, include_cross_terms=include_cross_terms, full_id=full_id)
