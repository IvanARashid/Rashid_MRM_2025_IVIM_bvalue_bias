...
def fig1_sequence(ax_column, sequence_design, plot_title, legend_flag=False):
    ...
    axins_sequence.fill_between(x=range(len(gwf_array[:,2])), y1=gwf_img[:,0], facecolor="grey", alpha=.4, label="Freq.")
    axins_sequence.fill_between(x=range(len(gwf_array[:,2])), y1=gwf_img[:,0], color="grey", facecolor="None", alpha=1, ls="-", lw=.8)

    axins_sequence.fill_between(x=range(len(gwf_array[:,2])), y1=gwf_img[:,1], facecolor="black", alpha=.4, label="Phase")
...
plot_powder_average(powder_average_xyz_bad, axs[1,0], "3 dir",(0, (5,5)))
...
plot_powder_average(powder_average_xyz_antipodal_bad, axs[1,0], "3 dir + antipodal", "-")
...
fig.legend(frameon=False, ncols=5, loc=(0.1, 0))
...
# 50 Nominal
axs[0,0].plot(z*1e3, [0 for i in range(len(z))], color="black", label="Nominal", ls=(0, (5,5)), lw=1)
# 50 Uncorrected
...
# 50 Cross-term
axs[0,0].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 1]*100, y2=maximum_bvalues_relative_c_worst_z[:, 1]*100, label="Accounting for cross-terms", facecolor="tab:green", ls="", alpha=alpha_area)
axs[0,0].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 1]*100, y2=maximum_bvalues_relative_c_worst_z[:, 1]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
axs[0,0].set_title("Nominal b = 50 s/mm$^2$")
axs[0,0].set_ylabel("Relative b-value error [\%]")
# Waveforms
#plot_waveform_inset(angles_worst_u, 50, axs[0,0], legend_flag=True)

# 200 Nominal
axs[0,1].plot(z*1e3, [0 for i in range(len(z))], color="black", ls=(0, (5,5)), lw=lw)
# 200 Uncorrected
...
# 200 Cross-term
axs[0,1].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 2]*100, y2=maximum_bvalues_relative_c_worst_z[:, 2]*100, facecolor="tab:green", ls="", alpha=alpha_area)
axs[0,1].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 2]*100, y2=maximum_bvalues_relative_c_worst_z[:, 2]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
axs[0,1].set_title("Nominal b = 200 s/mm$^2$")
#plot_waveform_inset(angles_worst_u, 200, axs[0,1])

# 800 Nominal
axs[0,2].plot(z*1e3, [0 for i in range(len(z))], color="black", ls=(0, (5,5)), lw=lw)
# 800 Uncorrected
...
# 800 Cross-term
axs[0,2].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 3]*100, y2=maximum_bvalues_relative_c_worst_z[:, 3]*100, facecolor="tab:green", ls="", alpha=alpha_area)
axs[0,2].fill_between(z*1e3, y1=minimum_bvalues_relative_c_worst_z[:, 3]*100, y2=maximum_bvalues_relative_c_worst_z[:, 3]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
...
# 50 Nominal
axs[1,0].plot(z*1e3, [0 for i in range(len(z))], color="black", ls=(0, (5,5)), lw=lw)
# 50 Uncorrected
...
# 50 Cross-term
axs[1,0].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 1]*100, y2=maximum_bvalues_relative_c_best_z[:, 1]*100, facecolor="tab:green", ls="", alpha=alpha_area)
axs[1,0].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 1]*100, y2=maximum_bvalues_relative_c_best_z[:, 1]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
axs[1,0].set_ylabel("Relative b-value error [\%]")
axs[1,0].set_xlabel("Isotropic resolution [mm]")
#plot_waveform_inset(angles_best_u, 50, axs[1,0])

# 200 Nominal
axs[1,1].plot(z*1e3, [0 for i in range(len(z))], color="black", ls=(0, (5,5)), lw=lw)
# 200 Uncorrected
...
# 200 Cross-term
axs[1,1].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 2]*100, y2=maximum_bvalues_relative_c_best_z[:, 2]*100, facecolor="tab:green", ls="", alpha=alpha_area)
axs[1,1].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 2]*100, y2=maximum_bvalues_relative_c_best_z[:, 2]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
axs[1,1].set_xlabel("Isotropic resolution [mm]")
#plot_waveform_inset(angles_best_u, 200, axs[1,1])

# 800 Nominal
axs[1,2].plot(z*1e3, [0 for i in range(len(z))], color="black", ls=(0, (5,5)), lw=lw)
# 800 Uncorrected
...
# 800 Cross-term
axs[1,2].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 3]*100, y2=maximum_bvalues_relative_c_best_z[:, 3]*100, facecolor="tab:green", ls="", alpha=alpha_area)
axs[1,2].fill_between(z*1e3, y1=minimum_bvalues_relative_c_best_z[:, 3]*100, y2=maximum_bvalues_relative_c_best_z[:, 3]*100, color="tab:green", facecolor="None", ls="-", alpha=alpha_lines, lw=lw)
# Settings
...
plot_3d_uvec_inset(fig, position=[.98, .43, 0.2, 0.5], angles=angles_worst_u)
plot_3d_uvec_inset(fig, position=[.98, -0.01, 0.2, 0.5], angles=angles_best_u)

fig.legend(frameon=False, ncols=4, loc=(.07, -.005))

fig.tight_layout()
fig.text(1, 0.89, "Large cross-terms", fontsize=16)
fig.text(0.99, .46, "Minimal cross-terms", fontsize=16)
fig.suptitle("Relative b-value errors vs. isotropic resolution", x=.53, y=1.02)
...
### f
# Nominal
axs[0,0].plot(z*1e3, f_u_worst[:,1]*100, color="black", label="Reference", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[0,0].plot(z*1e3, f_u_xyz_worst*100, color="tab:blue", ls=(0, (5,5)), label="3 dir", lw=lw)
axs[0,0].plot(z*1e3, f_i_xyz_worst*100, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[0,0].plot(z*1e3, f_c_xyz_worst*100, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[0,0].plot(z*1e3, f_u_xyz_antipodal_worst*100, color="tab:blue", ls="-", label="3 dir + antipodals", lw=lw)
axs[0,0].plot(z*1e3, f_i_xyz_antipodal_worst*100, color="tab:orange", ls="-", label="", lw=lw)
axs[0,0].plot(z*1e3, f_c_xyz_antipodal_worst*100, color="tab:green", ls="-", label="", lw=lw)
# Settings
...
### D*
# Nominal
axs[0,1].plot(z*1e3, Dstar_u_worst[:,1], color="black", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[0,1].plot(z*1e3, Dstar_u_xyz_worst, color="tab:blue", ls=(0, (5,5)), label="", lw=lw)
axs[0,1].plot(z*1e3, Dstar_i_xyz_worst, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[0,1].plot(z*1e3, Dstar_c_xyz_worst, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[0,1].plot(z*1e3, Dstar_u_xyz_antipodal_worst, color="tab:blue", ls="-", label="", lw=lw)
axs[0,1].plot(z*1e3, Dstar_i_xyz_antipodal_worst, color="tab:orange", ls="-", label="", lw=lw)
axs[0,1].plot(z*1e3, Dstar_c_xyz_antipodal_worst, color="tab:green", ls="-", label="", lw=lw)
# Settings
...
### D
# Nominal
axs[0,2].plot(z*1e3, D_u_worst[:,1], color="black", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[0,2].plot(z*1e3, D_u_xyz_worst, color="tab:blue", ls=(0, (5,5)), label="", lw=lw)
axs[0,2].plot(z*1e3, D_i_xyz_worst, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[0,2].plot(z*1e3, D_c_xyz_worst, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[0,2].plot(z*1e3, D_u_xyz_antipodal_worst, color="tab:blue", ls="-", label="", lw=lw)
axs[0,2].plot(z*1e3, D_i_xyz_antipodal_worst, color="tab:orange", ls="-", label="", lw=lw)
axs[0,2].plot(z*1e3, D_c_xyz_antipodal_worst, color="tab:green", ls="-", label="", lw=lw)
# Settings
...
### f
# Nominal
axs[1,0].plot(z*1e3, f_u_best[:,1]*100, color="black", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[1,0].plot(z*1e3, f_u_xyz_best*100, color="tab:blue", ls=(0, (5,5)), label="", lw=lw)
axs[1,0].plot(z*1e3, f_i_xyz_best*100, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[1,0].plot(z*1e3, f_c_xyz_best*100, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[1,0].plot(z*1e3, f_u_xyz_antipodal_best*100, color="tab:blue", ls="-", label="", lw=lw)
axs[1,0].plot(z*1e3, f_i_xyz_antipodal_best*100, color="tab:orange", ls="-", label="", lw=lw)
axs[1,0].plot(z*1e3, f_c_xyz_antipodal_best*100, color="tab:green", ls="-", label="", lw=lw)
...
fig_3_inset(axs[1,0], z*1e3, pwd_avg_lines=f_pwd_avg_lines, linestyles=linestyles, colors=colors, xlim=(2, 4), ylim=(9.8, 10.2), areas=f_areas)

### D*
# Nominal
axs[1,1].plot(z*1e3, Dstar_u_best[:,1], color="black", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[1,1].plot(z*1e3, Dstar_u_xyz_best, color="tab:blue", ls=(0, (5,5)), label="", lw=lw)
axs[1,1].plot(z*1e3, Dstar_i_xyz_best, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[1,1].plot(z*1e3, Dstar_c_xyz_best, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[1,1].plot(z*1e3, Dstar_u_xyz_antipodal_best, color="tab:blue", ls="-", label="", lw=lw)
axs[1,1].plot(z*1e3, Dstar_i_xyz_antipodal_best, color="tab:orange", ls="-", label="", lw=lw)
axs[1,1].plot(z*1e3, Dstar_c_xyz_antipodal_best, color="tab:green", ls="-", label="", lw=lw)
...
fig_3_inset(axs[1,1], z*1e3, pwd_avg_lines=Dstar_pwd_avg_lines, linestyles=linestyles, colors=colors, xlim=(2, 4), ylim=(19, 21), areas=Dstar_areas)

### D
# Nominal
axs[1,2].plot(z*1e3, D_u_best[:,1], color="black", ls=(0,(5,5)), lw=1)
# Uncorrected
...
# Powder avgs xyz
axs[1,2].plot(z*1e3, D_u_xyz_best, color="tab:blue", ls=(0, (5,5)), label="", lw=lw)
axs[1,2].plot(z*1e3, D_i_xyz_best, color="tab:orange", ls=(0, (5,5)), label="", lw=lw)
axs[1,2].plot(z*1e3, D_c_xyz_best, color="tab:green", ls=(0, (5,5)), label="", lw=lw)
...
axs[1,2].plot(z*1e3, D_u_xyz_antipodal_best, color="tab:blue", ls="-", label="", lw=lw)
axs[1,2].plot(z*1e3, D_i_xyz_antipodal_best, color="tab:orange", ls="-", label="", lw=lw)
axs[1,2].plot(z*1e3, D_c_xyz_antipodal_best, color="tab:green", ls="-", label="", lw=lw)
...
fig_3_inset(axs[1,2], z*1e3, pwd_avg_lines=D_pwd_avg_lines, linestyles=linestyles, colors=colors, xlim=(2, 4), ylim=(0.99, 1.01), areas=D_areas)
...
#fig.savefig(os.path.join(fig_save_path, "fig3.pdf"), bbox_inches="tight")
