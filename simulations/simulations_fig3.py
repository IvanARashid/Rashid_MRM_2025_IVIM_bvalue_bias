...
def main1(sequence_config=sequence_config, save_path=save_path, uvec_file=uvec_file, resolution_lst=resolution_lst):
    full_id = False
...
def main2(sequence_config=sequence_config, save_path=save_path, uvec_file=uvec_file, resolution_lst=resolution_lst):
    full_id = False
...
def main3(sequence_config=sequence_config, save_path=save_path, uvec_file=uvec_file, resolution_lst=resolution_lst):
